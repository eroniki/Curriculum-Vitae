...
\section{Relevant Professional Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Computer Vision Engineer developing orthorechtified maps with aerial photos taken by on autonomous UAVs.}{Remote}
      \resumeItemListStart
...
\section{Achievements}
    ...
    \resumeSubHeadingListStart
		\resumeProjectHeading
		{
			...
			\qquad \small Supervisors: A Akanmu, J Iorio $|$ Sponsor: MLSoC DEI Committee
		}
		{}
		\resumeItemListStart
		...
		\resumeProjectHeading
		{
			...
			\qquad \small Advisors: P Plassmann, CF Jones $|$ Related publications: \cite{ambarkutuk2023,ambarkutuk2021uncertainty,sa2021investigation, sa2020towards}
		}
		{}
		\resumeItemListStart
