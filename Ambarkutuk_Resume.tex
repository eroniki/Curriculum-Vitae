...
\section{Relevant Professional Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
 		\resumeItem{Collaborated with a team of developers to develop a software product that generates 2D and 3D maps with photos taken by an autonomous UAV in stages.}
...
\section{Community Service \& Leadership}
    \resumeSubHeadingListStart
		\resumeSubheading{Society of Experimental Mechanics}{Spring-2021 -- Present}{Student Member}{Virginia Tech}
		\resumeSubheading{IEEE Robotics and Automation Society}{Fall 2018 -- Present}{Reviewer}{Virginia Tech}
		\resumeItemListStart
